...
# Fungsi penanganan nilai NaN agar tidak crash/eror
...
def analyze_stock(ticker_symbol):
    ...
    try:
        waktu_ambil = datetime.now().strftime("%d-%m-%Y %H:%M:%S WIB")
        ...
        # Membungkus teks dengan tag <pre>...</pre> agar menjadi blok kode
        msg = "<pre>"
        msg += f"==============================\n"
